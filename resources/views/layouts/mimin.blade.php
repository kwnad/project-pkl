...
<head>
    ...
    <link rel="stylesheet" href="tml/assets/css/bootstrap.css">
    
    <link rel="stylesheet" href="tml/assets/vendors/chartjs/Chart.min.css">

    <link rel="stylesheet" href="tml/assets/vendors/perfect-scrollbar/perfect-scrollbar.css">
    <link rel="stylesheet" href="tml/assets/css/app.css">
    <link rel="shortcut icon" href="tml/assets/images/favicon.svg" type="image/x-icon">
</head>
<body>
    ...
    <div class="sidebar-header ">
        <img src="tml/assets/images/logo.svg" alt="" srcset="">
    </div>
                        ...
                        <li class="dropdown">
                            <a href="#" data-bs-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                                <div class="avatar me-1">
                                    <img src="tml/assets/images/avatar/avatar-s-1.png" alt="" srcset="">
                                </div>
 ...
 <div class="main-content container-fluid">
    ...
    <script src="tml/assets/js/feather-icons/feather.min.js"></script>
    <script src="tml/assets/vendors/perfect-scrollbar/perfect-scrollbar.min.js"></script>
    <script src="tml/assets/js/app.js"></script>
    
    <script src="tml/assets/vendors/chartjs/Chart.min.js"></script>
    <script src="tml/assets/vendors/apexcharts/apexcharts.min.js"></script>
    <script src="tml/assets/js/pages/dashboard.js"></script>

    <script src="tml/assets/js/main.js"></script>
</body>
</html>
